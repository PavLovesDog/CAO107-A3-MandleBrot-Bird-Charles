...
GLuint ShaderLoader::CreateProgram(char* computeShaderFile)
{

	//read the shader files and save the code
	std::string compute_shader_code = ReadShader(computeShaderFile);
...
GLuint ShaderLoader::CreateProgram(char* VertexShaderFilename, char* FragmentShaderFilename, char* TesShaderControlFile, char* TesShaderEvlFile)
{
	return GLuint();
}
